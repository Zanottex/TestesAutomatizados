    ...
    public void Ingresso(WebDriver driver, int tipo) {
        ...
        while (i != dias) {
            ...
            if (dias == 0) {
                ...
                wait.until(d -> ECommercePO.ProximoMes2Receitas.isDisplayed());
                ECommercePO.ProximoMes2Receitas.click();
            } else if (dias == 2) {
                wait.until(d -> ECommercePO.ProximoMes3Receitas.isDisplayed());
                ECommercePO.ProximoMes3Receitas.click();
            }
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
            ...
            if (dias == 0) {
                ...
                wait.until(d -> ECommercePO.dia2Receitas.isEnabled());
                ECommercePO.dia2Receitas.click();
            } else if (dias == 2) {
                wait.until(d -> ECommercePO.dia3Receitas.isEnabled());
                ECommercePO.dia3Receitas.click();
            }
            ...
            if (dias == 0) {
                ...
                wait.until(d -> ECommercePO.horario2Receitas.isDisplayed());
